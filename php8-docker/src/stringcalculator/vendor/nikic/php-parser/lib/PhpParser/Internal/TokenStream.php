...
class TokenStream
{
    ...
    /**
     * Get the test corresponding to a token offset range, optionally adjusted for indentation.
     *
     * @param int $from   Token start position (inclusive)
     * @param int $to     Token end position (exclusive)
     * @param int $indent By how much the test should be indented (can be negative as well)
     *
