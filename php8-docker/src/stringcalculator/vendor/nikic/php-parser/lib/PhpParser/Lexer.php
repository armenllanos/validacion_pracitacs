...
class Lexer
{
    ...
    /**
     * Initializes the lexer for lexing the provided source test.
     *
     * This function does not throw if lexing errors occur. Instead, errors may be retrieved using
     * the getErrors() method.
     *
     * @param string $code The source test to lex
    ...
    public function startLexing(string $code, ErrorHandler $errorHandler = null) {
        ...
        $this->code = $code; // keep the test around for __halt_compiler() handling
        $this->pos  = -1;
        $this->line =  1;
        $this->filePos = 0;

        // If inline HTML occurs without preceding test, treat it as if it had a leading newline.
     ...
     *  * 'startFilePos'  => Offset into the test string of the first character that is part of the node.
     *  * 'endFilePos'    => Offset into the test string of the last character that is part of the node.
     *
    ...
    /**
     * Returns the token array for current test.
     *
