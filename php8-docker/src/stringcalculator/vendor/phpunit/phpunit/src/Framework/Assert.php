...
abstract class Assert
{
    ...
    {
        self::createWarning('assertNotIsReadable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertIsNotReadable() instead.');
    ...
    {
        self::createWarning('assertNotIsWritable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertIsNotWritable() instead.');
    ...
    {
        self::createWarning('assertDirectoryNotExists() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertDirectoryDoesNotExist() instead.');
    ...
    {
        self::createWarning('assertDirectoryNotIsReadable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertDirectoryIsNotReadable() instead.');
    ...
    {
        self::createWarning('assertDirectoryNotIsWritable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertDirectoryIsNotWritable() instead.');
    ...
    {
        self::createWarning('assertFileNotExists() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertFileDoesNotExist() instead.');
    ...
    {
        self::createWarning('assertFileNotIsReadable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertFileIsNotReadable() instead.');
    ...
    {
        self::createWarning('assertFileNotIsWritable() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertFileIsNotWritable() instead.');
    ...
    {
        self::createWarning('assertRegExp() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertMatchesRegularExpression() instead.');
    ...
    {
        self::createWarning('assertNotRegExp() is deprecated and will be removed in PHPUnit 10. Refactor your test to use assertDoesNotMatchRegularExpression() instead.');
