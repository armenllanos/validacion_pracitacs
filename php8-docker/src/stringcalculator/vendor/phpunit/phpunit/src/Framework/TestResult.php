...
final class TestResult implements Countable
{
    ...
    /**
     * Returns whether test coverage information should be collected.
     */
        ...
        if ($collectCodeCoverage) {
            ...
            try {
                ...
                $unintentionallyCoveredCodeError = new UnintentionallyCoveredCodeError(
                    'This test executed test that is not listed as test to be covered or used:' .
    ...
    /**
     * Returns the test coverage object.
     */
