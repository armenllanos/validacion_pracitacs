...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'Code Coverage Options' => [
            ['arg' => '--coverage-clover <file>', 'desc' => 'Generate test coverage report in Clover XML format'],
            ['arg' => '--coverage-cobertura <file>', 'desc' => 'Generate test coverage report in Cobertura XML format'],
            ['arg' => '--coverage-crap4j <file>', 'desc' => 'Generate test coverage report in Crap4J XML format'],
            ['arg' => '--coverage-html <dir>', 'desc' => 'Generate test coverage report in HTML format'],
            ['arg' => '--coverage-php <file>', 'desc' => 'Export PHP_CodeCoverage object to file'],
            ['arg' => '--coverage-text=<file>', 'desc' => 'Generate test coverage report in text format [default: standard output]'],
            ['arg' => '--coverage-xml <dir>', 'desc' => 'Generate test coverage report in PHPUnit XML format'],
            ['arg' => '--coverage-cache <dir>', 'desc' => 'Cache static analysis results'],
            ['arg' => '--warm-coverage-cache', 'desc' => 'Warm static analysis cache'],
            ['arg' => '--coverage-filter <dir>', 'desc' => 'Include <dir> in test coverage analysis'],
            ['arg' => '--path-coverage', 'desc' => 'Perform path coverage analysis'],
            ['arg' => '--disable-coverage-ignore', 'desc' => 'Disable annotations for ignoring test coverage'],
            ['arg' => '--no-coverage', 'desc' => 'Ignore test coverage configuration'],
        ],
